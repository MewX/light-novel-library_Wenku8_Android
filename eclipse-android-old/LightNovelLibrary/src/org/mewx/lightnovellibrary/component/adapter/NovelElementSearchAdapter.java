...
public class NovelElementSearchAdapter extends BaseAdapter {
	private Context context;
	private Adapter ad;
	private List<NovelElementSearch> ele;
	private List<Integer> imgList;

	public NovelElementSearchAdapter(Context context,
			List<NovelElementSearch> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final NovelElementSearch e = getItem(position);
		if (convertView == null) {
			// convertView = LayoutInflater.from(this.context).inflate(
			// R.layout.layout_novel_button, parent, false);
			convertView = LayoutInflater.from(this.context).inflate(
					R.layout.activity_novel_button_search, parent, false);
		}

		// set texts
		TextView txt = (TextView) convertView.findViewById(R.id.novel_name);
		txt.setText(e.getTitle());
		txt = (TextView) convertView.findViewById(R.id.novel_author_text);
		txt.setText(e.getAuthor());
		txt = (TextView) convertView.findViewById(R.id.novel_update_text);
		txt.setText(String.valueOf(e.getUpdate()));
		txt = (TextView) convertView.findViewById(R.id.novel_short_intro_text);
		txt.setText(String.valueOf(e.getIntro()));

		if (e.getStatus() == 0)
			((TextView) convertView.findViewById(R.id.novel_bookstatus_text))
					.setText(convertView
							.getResources()
							.getString(
									GlobalConfig.getFetchLanguage() == Wenku8Interface.LANG.SC ? R.string.novel_status_0_sc
											: R.string.novel_status_0_tc));
		else
			((TextView) convertView.findViewById(R.id.novel_bookstatus_text))
					.setText(convertView
							.getResources()
							.getString(
									GlobalConfig.getFetchLanguage() == Wenku8Interface.LANG.SC ? R.string.novel_status_1_sc
											: R.string.novel_status_1_tc));
	...
	@Override
	public NovelElementSearch getItem(int position) {
